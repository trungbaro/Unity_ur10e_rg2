...
struct DisplayRobotState_
{
  ...
  _state_type state;
   ...
   typedef std::vector< ::moveit_msgs::ObjectColor_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::ObjectColor_<ContainerAllocator> >> _highlight_links_type;

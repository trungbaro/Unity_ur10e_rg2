...
struct GenericTrajectory_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::trajectory_msgs::JointTrajectory_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::trajectory_msgs::JointTrajectory_<ContainerAllocator> >> _joint_trajectory_type;
  _joint_trajectory_type joint_trajectory;

   typedef std::vector< ::moveit_msgs::CartesianTrajectory_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::CartesianTrajectory_<ContainerAllocator> >> _cartesian_trajectory_type;

...
struct PlaceResult_
{
  ...
  _trajectory_start_type trajectory_start;
   ...
   typedef std::vector< ::moveit_msgs::RobotTrajectory_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::RobotTrajectory_<ContainerAllocator> >> _trajectory_stages_type;
  _trajectory_stages_type trajectory_stages;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _trajectory_descriptions_type;
...
struct Printer< ::moveit_msgs::PlaceResult_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::PlaceResult_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "trajectory_stages: ";
    if (v.trajectory_stages.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.trajectory_stages.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::moveit_msgs::RobotTrajectory_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.trajectory_stages[i]);
    }
    if (v.trajectory_stages.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "trajectory_descriptions: ";
    if (v.trajectory_descriptions.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.trajectory_descriptions.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.trajectory_descriptions[i]);
    }
    if (v.trajectory_descriptions.empty() || true)
      s << "]";
    if (true || !indent.empty())

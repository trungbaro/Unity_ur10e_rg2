...
struct MotionPlanRequest_
{
  ...
  _start_state_type start_state;
   ...
   typedef std::vector< ::moveit_msgs::Constraints_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::Constraints_<ContainerAllocator> >> _goal_constraints_type;
  ...
  _trajectory_constraints_type trajectory_constraints;
   ...
   typedef std::vector< ::moveit_msgs::GenericTrajectory_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::GenericTrajectory_<ContainerAllocator> >> _reference_trajectories_type;
  ...
  _max_acceleration_scaling_factor_type max_acceleration_scaling_factor;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _cartesian_speed_end_effector_link_type;
...
struct MD5Sum< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x06f232a8d98582f4ULL;
  static const uint64_t static_value2 = 0x91d96e82023b5025ULL;
};

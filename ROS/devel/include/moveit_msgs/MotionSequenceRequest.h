...
struct MotionSequenceRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::MotionSequenceItem_<ContainerAllocator> >> _items_type;
  _items_type items;
...
struct MD5Sum< ::moveit_msgs::MotionSequenceRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x57cf6288629c6c04ULL;
  static const uint64_t static_value2 = 0x4521c00da1e0b4a2ULL;
};

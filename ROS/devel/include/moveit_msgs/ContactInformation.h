...
struct ContactInformation_
{
  ...
  _depth_type depth;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _contact_body_1_type;
  _contact_body_1_type contact_body_1;

   typedef uint32_t _body_type_1_type;
  _body_type_1_type body_type_1;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _contact_body_2_type;

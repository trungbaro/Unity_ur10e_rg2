...
struct MD5Sum< ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator> >
{
  ...
  {
    return "6514728724a6f4ce3f2f5a26db255bc9";
  }

  static const char* value(const ::moveit_msgs::MoveGroupActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6514728724a6f4ceULL;
  static const uint64_t static_value2 = 0x3f2f5a26db255bc9ULL;
};

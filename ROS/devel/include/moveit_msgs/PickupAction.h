...
struct MD5Sum< ::moveit_msgs::PickupAction_<ContainerAllocator> >
{
  ...
  {
    return "5317974572447491b80b68b34261fbc2";
  }

  static const char* value(const ::moveit_msgs::PickupAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5317974572447491ULL;
  static const uint64_t static_value2 = 0xb80b68b34261fbc2ULL;
};

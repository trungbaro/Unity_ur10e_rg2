...
struct PlanningScene_
{
  ...
  _robot_state_type robot_state;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _robot_model_name_type;
  _robot_model_name_type robot_model_name;

   typedef std::vector< ::geometry_msgs::TransformStamped_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::TransformStamped_<ContainerAllocator> >> _fixed_frame_transforms_type;
  ...
  _allowed_collision_matrix_type allowed_collision_matrix;
   ...
   typedef std::vector< ::moveit_msgs::LinkPadding_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::LinkPadding_<ContainerAllocator> >> _link_padding_type;
  _link_padding_type link_padding;

   typedef std::vector< ::moveit_msgs::LinkScale_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::LinkScale_<ContainerAllocator> >> _link_scale_type;
  _link_scale_type link_scale;

   typedef std::vector< ::moveit_msgs::ObjectColor_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::ObjectColor_<ContainerAllocator> >> _object_colors_type;

...
struct Constraints_
{
  ...
  _joint_constraints_type joint_constraints;
   ...
   typedef std::vector< ::moveit_msgs::PositionConstraint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::PositionConstraint_<ContainerAllocator> >> _position_constraints_type;
  _position_constraints_type position_constraints;

   typedef std::vector< ::moveit_msgs::OrientationConstraint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::OrientationConstraint_<ContainerAllocator> >> _orientation_constraints_type;
  _orientation_constraints_type orientation_constraints;

   typedef std::vector< ::moveit_msgs::VisibilityConstraint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::VisibilityConstraint_<ContainerAllocator> >> _visibility_constraints_type;

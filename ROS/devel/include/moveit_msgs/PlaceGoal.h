...
struct PlaceGoal_
{
  ...
  _group_name_type group_name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _attached_object_name_type;
  _attached_object_name_type attached_object_name;

   typedef std::vector< ::moveit_msgs::PlaceLocation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::PlaceLocation_<ContainerAllocator> >> _place_locations_type;
...
struct MD5Sum< ::moveit_msgs::PlaceGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xa753b01e9aff8022ULL;
  static const uint64_t static_value2 = 0xcdce180c4a8392d2ULL;
};

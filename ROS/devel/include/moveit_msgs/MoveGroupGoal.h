...
struct MD5Sum< ::moveit_msgs::MoveGroupGoal_<ContainerAllocator> >
{
  ...
  {
    return "b0ad103dddb8ad720ce511832f30d4b9";
  }

  static const char* value(const ::moveit_msgs::MoveGroupGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb0ad103dddb8ad72ULL;
  static const uint64_t static_value2 = 0x0ce511832f30d4b9ULL;
};

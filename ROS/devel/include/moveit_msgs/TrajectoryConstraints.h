...
struct TrajectoryConstraints_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::moveit_msgs::Constraints_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::Constraints_<ContainerAllocator> >> _constraints_type;

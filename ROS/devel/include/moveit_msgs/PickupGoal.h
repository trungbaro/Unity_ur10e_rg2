...
struct PickupGoal_
{
  ...
  _group_name_type group_name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _end_effector_type;
  _end_effector_type end_effector;

   typedef std::vector< ::moveit_msgs::Grasp_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::moveit_msgs::Grasp_<ContainerAllocator> >> _possible_grasps_type;
  _possible_grasps_type possible_grasps;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _support_surface_name_type;
  ...
  _allow_gripper_support_collision_type allow_gripper_support_collision;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _attached_object_touch_links_type;
  ...
  _path_constraints_type path_constraints;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _planner_id_type;
...
struct MD5Sum< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x338e5f9b0dad5dc7ULL;
  static const uint64_t static_value2 = 0x671aaf11ec23ba67ULL;
};
...
struct Printer< ::moveit_msgs::PickupGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::PickupGoal_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.end_effector);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "possible_grasps: ";
    if (v.possible_grasps.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.possible_grasps.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::moveit_msgs::Grasp_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.possible_grasps[i]);
    }
    if (v.possible_grasps.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "attached_object_touch_links: ";
    if (v.attached_object_touch_links.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.attached_object_touch_links.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.attached_object_touch_links[i]);
    }
    if (v.attached_object_touch_links.empty() || true)
      s << "]";
    if (true || !indent.empty())

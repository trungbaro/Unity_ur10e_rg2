...
(cl:in-package ur10e_rg2_moveit-srv)
...
(cl:defclass <MoverService-request> (roslisp-msg-protocol:ros-message)
  ((joints_input
    ...
    :type ur10e_rg2_moveit-msg:Ur10eMoveitJoints
    :initform (cl:make-instance 'ur10e_rg2_moveit-msg:Ur10eMoveitJoints))
   (pick_pose
    :reader pick_pose
    :initarg :pick_pose
...
(cl:defmethod cl:initialize-instance :after ((m <MoverService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoverService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur10e_rg2_moveit-srv:<MoverService-request> is deprecated: use ur10e_rg2_moveit-srv:MoverService-request instead.")))

(cl:ensure-generic-function 'joints_input-val :lambda-list '(m))
(cl:defmethod joints_input-val ((m <MoverService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10e_rg2_moveit-srv:joints_input-val is deprecated.  Use ur10e_rg2_moveit-srv:joints_input instead.")
  (joints_input m))

(cl:ensure-generic-function 'pick_pose-val :lambda-list '(m))
(cl:defmethod pick_pose-val ((m <MoverService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10e_rg2_moveit-srv:pick_pose-val is deprecated.  Use ur10e_rg2_moveit-srv:pick_pose instead.")
  (pick_pose m))

(cl:ensure-generic-function 'place_pose-val :lambda-list '(m))
(cl:defmethod place_pose-val ((m <MoverService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10e_rg2_moveit-srv:place_pose-val is deprecated.  Use ur10e_rg2_moveit-srv:place_pose instead.")
  (place_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoverService-request>)))
  ...
  "ur10e_rg2_moveit/MoverServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoverService-request)))
  "Returns string type for a service object of type 'MoverService-request"
  "ur10e_rg2_moveit/MoverServiceRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoverService-request>)))
  ...
  (cl:format cl:nil "# Service request~%Ur10eMoveitJoints joints_input~%geometry_msgs/Pose pick_pose~%geometry_msgs/Pose place_pose~%~%~%================================================================================~%MSG: ur10e_rg2_moveit/Ur10eMoveitJoints~%float64[6] joints~%geometry_msgs/Pose pick_pose~%geometry_msgs/Pose place_pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoverService-request)))
  "Returns full string definition for message of type 'MoverService-request"
  (cl:format cl:nil "# Service request~%Ur10eMoveitJoints joints_input~%geometry_msgs/Pose pick_pose~%geometry_msgs/Pose place_pose~%~%~%================================================================================~%MSG: ur10e_rg2_moveit/Ur10eMoveitJoints~%float64[6] joints~%geometry_msgs/Pose pick_pose~%geometry_msgs/Pose place_pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <MoverService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoverService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur10e_rg2_moveit-srv:<MoverService-response> is deprecated: use ur10e_rg2_moveit-srv:MoverService-response instead.")))

(cl:ensure-generic-function 'trajectories-val :lambda-list '(m))
(cl:defmethod trajectories-val ((m <MoverService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur10e_rg2_moveit-srv:trajectories-val is deprecated.  Use ur10e_rg2_moveit-srv:trajectories instead.")
  (trajectories m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoverService-response>)))
  ...
  "ur10e_rg2_moveit/MoverServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoverService-response)))
  "Returns string type for a service object of type 'MoverService-response"
  "ur10e_rg2_moveit/MoverServiceResponse")

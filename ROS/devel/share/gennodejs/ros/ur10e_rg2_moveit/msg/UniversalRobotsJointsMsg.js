...
// (in-package ur10e_rg2_moveit.msg)
...
class UniversalRobotsJointsMsg {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UniversalRobotsJointsMsg(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UniversalRobotsJointsMsg(null);
...
module.exports = UniversalRobotsJointsMsg;

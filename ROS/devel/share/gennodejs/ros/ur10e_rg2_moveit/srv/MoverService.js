...
// (in-package ur10e_rg2_moveit.srv)
...
let Ur10eMoveitJoints = require('../msg/Ur10eMoveitJoints.js');
...
class MoverServiceRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('joints_input')) {
        ...
        this.joints_input = new Ur10eMoveitJoints();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Ur10eMoveitJoints.serialize(obj.joints_input, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.joints_input = Ur10eMoveitJoints.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.joints_input !== undefined) {
      resolved.joints_input = Ur10eMoveitJoints.Resolve(msg.joints_input)
    }
    else {
      resolved.joints_input = new Ur10eMoveitJoints()
    }
...
class MoverServiceResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ur10e_rg2_moveit/MoverServiceResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ur10e_rg2_moveit/MoverService'; }
};

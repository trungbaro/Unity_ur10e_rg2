...
{
    [Serializable]
    public class UniversalRobotsJointsMsgMsg : Message
    {
        public const string k_RosMessageName = "ur10e_rg2_moveit/UniversalRobotsJointsMsg";
        ...
        public UniversalRobotsJointsMsgMsg()
        {
        ...
        public UniversalRobotsJointsMsgMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
            this.joints = joints;
        ...
        public static UniversalRobotsJointsMsgMsg Deserialize(MessageDeserializer deserializer) => new UniversalRobotsJointsMsgMsg(deserializer);

        private UniversalRobotsJointsMsgMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "UniversalRobotsJointsMsgMsg: " +

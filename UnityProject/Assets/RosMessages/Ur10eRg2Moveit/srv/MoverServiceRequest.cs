...
namespace RosMessageTypes.Ur10eRg2Moveit
{
    ...
    {
        public const string k_RosMessageName = "ur10e_rg2_moveit/MoverService";
        public override string RosMessageName => k_RosMessageName;

        //  Service request
        public Ur10eMoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new Ur10eMoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(Ur10eMoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = Ur10eMoveitJointsMsg.Deserialize(deserializer);
